abstract class Assetpaths {
  static GetStartAssetPaths get getStartAssetPaths => GetStartAssetPaths();
  static HomeAssetPaths get homeAssetPaths => HomeAssetPaths();
...
class GetStartAssetPaths {
  final getStartImg1 = 'asset/get_start/get_statrt_img.png';
...
class ProfileAssetPaths {
  final cameraImg = 'asset/profile/camera.png';
  final editBtnImg = 'asset/profile/edit_btn.png';
  final personImg = 'asset/profile/person.png';
}

class MainPageAssetPaths {
  final activityIcon = 'asset/activity.png';
  final homeIcon = 'asset/home.png';
  final walletIcon = 'asset/wallet.png';
}

class PaymentAssetPaths {
