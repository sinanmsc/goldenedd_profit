...
class AuthEvent with _$AuthEvent {
  ...
  const factory AuthEvent.login(String email,String password,BuildContext context) = _LogIn;
  const factory AuthEvent.signUp(String email,String password,BuildContext context) = _SignUp;
